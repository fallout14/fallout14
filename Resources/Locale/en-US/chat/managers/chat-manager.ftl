...
# #Cythisiax Added - Admin chat hook wrap for Discord bot reverse relay (restored from fallout14-old)
chat-manager-send-hook-adminchat-wrap-message = ADMIN: (D){$senderName}: {$message}
