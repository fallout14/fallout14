...
class YAMLExtractor:
    ...
    def create_en_fluent_file(self, relative_parent_dir, file_name, file_data):
        ...
        logging.info(f'Updated English locale file {en_fluent_file.full_path}')
    ...
    def create_ru_fluent_file(self, en_analog_file_path):
        ...
        if os.path.isfile(ru_file_full_path):
            ...
            logging.info(f'Created Russian locale file {ru_file_full_path}')
...
logging.info(f'Searching for yaml files ...')
